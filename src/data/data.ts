/* Mock data for the WORKO app. Replace with real data sources as the backend lands. */
...
export const WORKO_DATA = {
  ...
  upNext: [
    { title: "Review Q3 roadmap with Sam", estimate: "20 min", priority: "Medium" as Priority },
    { title: "Reply to design feedback", estimate: "10 min", priority: "Low" as Priority },
    { title: "Approve final hero illustration", estimate: "5 min", priority: "Medium" as Priority },
  ],
